...
# template_folder = "C:\Users\Cha Cha\OneDrive - kmutnb.ac.th\web-baseapp1\" + "templates\"  
#                 = "C:\Users\Cha Cha\OneDrive - kmutnb.ac.th\web-baseapp1\templates\"          
...
def post_data():
    ...
    return "<B>I am 555" + name + ', ' + age + " years. This is my" + email + "</B>"
...
def adduser_todb():
    ...
    conn.commit() #INSERT, UPDATE, DELETE use commit
    conn.close()
    return redirect('/')
...
def delete(idmemo):
    ...
    data = (idmemo,) #tuple must have comma unless it will see as string
...
def edit(idmemo):
    ...
    data = (idmemo,) #tuple must have comma unless it will see
